<aside class="sidenav  bg-gray-600 navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            {{-- Dashboard --}}
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('company.home') ? 'active' : '' }}" href="{{ route('company.home') }}">
            ...
            {{-- Reservaciones --}}
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('company.video.*') ? 'active' : '' }}" href="{{ route('company.video.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
